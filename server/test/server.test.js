  ...
  it('should remove a todo', (done) => {
      ...
      request(app)
        ...
        .end((err, res) => {
          ...
          //query database using finById toNotExist
...
describe('DELETE /users/me/token', () => {
  it('it shouold remove auth token on logout', (done) =>{
    // DELETE /users/me/token
    // Set x-auth equal to token
    // 200
    // Find user, verify that token array has length zero
    request(app)
      .delete('/users/me/token')
      .set('x-auth', users[0].tokens[0].token)
      .expect(200)
